...
from utils.config import CHANNEL_NAMES, INTERVALS, T_MAX, T_MIN, SCALE, best_clusters
...
if __name__ == '__main__':
    ...
    if name_region =='all':
        ERP_high = ERP_high*5e14 # Scale 5e14 times to plot image for all
        ERP_low = ERP_low*5e14   
    ...
    # plt.show()
    fig.savefig(output_folder + f'/{name_region}_ERPs_{word_type}.png', dpi=500, bbox_inches='tight')
    ...
    print(f"\nAll saved in folder {output_folder}")
