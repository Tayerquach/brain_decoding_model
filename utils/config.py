...
content_selected_chans = ['CP1', 'CP5', 'F3', 'F7', 'FT9', 'P7', 'T7', 'TP9', 'Cz', 'Fz', 'Oz', 'Pz', 'CP2', 'CP6', 'F4', 'P8', 'T8']
function_selected_chans = ['C3','CP1','F3','F7','FC1','T7','TP9','Cz','C4','CP6','F4','FC2','FC6','P8'],
NOUN_selected_chans = ['CP1', 'F3', 'F7', 'FT9', 'P7', 'T7', 'Cz', 'Fz', 'CP6', 'F4', 'T8'],
